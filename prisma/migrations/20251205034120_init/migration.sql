-- CreateEnum
CREATE TYPE "StatutDemande" AS ENUM ('EN_ATTENTE', 'APPROUVEE', 'REFUSEE', 'ANNULEE', 'TERMINEE');
...
CREATE TABLE "directions" (
    ...
    "directeur_phone" TEXT,
    "motif_creation" TEXT,
    "nombre_bureau" TEXT,
    "nombre_service" TEXT,
    "numero_direction" TEXT,
...
CREATE TABLE "services" (
    ...
    "date_creation" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "id_direction" TEXT NOT NULL,
    "id_chefdeservice" TEXT DEFAULT 'a definir',
...
CREATE TABLE "personnels" (
    ...
    "disponibilité_day" INTEGER NOT NULL DEFAULT 45,
...
CREATE TABLE "discussions" (
    ...
    "heure_message" TEXT,
    "id_demande" TEXT NOT NULL,
    "auteur_message" TEXT NOT NULL DEFAULT 'inconnu',
